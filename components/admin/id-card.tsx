...
function IdHeader() {
  return (
    <header className="relative z-10 flex h-[11.8cqw] shrink-0 items-center bg-[linear-gradient(135deg,#0f3d26,#1b5c38)] pl-[0.91cqw] pr-[1.82cqw]">
      <Image
        src="/logo2.png"
        alt="Pi Gamma Phi Gamma Sigma logo"
        width={360}
        height={80}
        className="h-[8.6cqw] w-[59.1cqw] object-contain"
      />
    </header>
  );
}
