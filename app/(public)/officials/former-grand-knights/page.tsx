...
export default function Page() {
  return (
    <PageShell title="Former Grand Knights">
      <div className="mb-10 max-w-2xl">
        <p className="text-base leading-7">
          Honoring the brothers who have served as Grand Knights. Names,
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {formerGrandKnights.map((grandKnight) => (
          <article
            key={`${grandKnight.from}-${grandKnight.until}`}
          ...
          >
            <div className="relative aspect-[4/5] bg-[var(--green-soft)]">
              <Image
                ...
                alt={`${grandKnight.name}, former Grand Knight`}
                fill
