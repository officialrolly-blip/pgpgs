...
export default function Page() {
  return (
    <PageShell title="Pi Gamma Phi Gamma Sigma History">
      <article className="max-w-4xl text-justify text-[1.05rem]/8 text-black/75">
        ...
        <p className="mb-6 first-letter:float-left first-letter:mr-2 first-letter:font-serif first-letter:text-7xl first-letter:font-semibold first-letter:leading-[0.75] first-letter:text-[var(--green)]">
          ...
          founders made an agreement to call every member of{" "}
          <strong>Pi Gamma Phi</strong> as
          <strong> GAMMA SIGMA</strong> means brothers and sisters in PI GAMMA
          PHI.
        </p>
        ...
        <p className="mb-6">
          ...
          Visayas, Mindanao, the <strong>CONSEJO NACIONAL INTERNATIONAL</strong>{" "}
          emerged. The{" "}
          <strong>
            Pi Gamma Phi (ΓΣ) Consejo Nacional International Incorporated
          </strong>
        ...
        <div className="my-10 grid gap-px overflow-hidden bg-[var(--gold)]/30 shadow-[0_12px_28px_rgba(15,61,38,0.08)] sm:grid-cols-3">
          <div className="bg-[var(--green-soft)] p-7 text-center transition-transform hover:scale-[1.02]">
            <p className="font-serif text-4xl font-semibold text-[var(--green-dark)]">
              PI
            </p>
            <p className="mt-3 text-sm leading-6">
              Came from founder Ysmael Ulanday, a former member of Pi Beta.
            </p>
          </div>
          <div className="bg-[var(--green-soft)] p-7 text-center transition-transform hover:scale-[1.02]">
            <p className="font-serif text-4xl font-semibold text-[var(--green-dark)]">
            ...
            <p className="mt-3 text-sm leading-6">
              Came from founder Enrique Gomez, a former member of Tau Gamma Phi.
            </p>
          </div>
          <div className="bg-[var(--green-soft)] p-7 text-center transition-transform hover:scale-[1.02]">
            <p className="font-serif text-4xl font-semibold text-[var(--green-dark)]">
            ...
            <p className="mt-3 text-sm leading-6">
              Came from founder Henry Pesimo, a former member of Delta Phi
              Omega.
            </p>
          </div>
        </div>
        ...
        <p className="mb-6">
          ...
          <strong> GAMMA SIGMA</strong> as the name of the individual member of
          Pi Gamma Phi. The Fraternity/Sorority name is{" "}
          <strong>PI GAMMA PHI</strong> and the member’s name is{" "}
          <strong>GAMMA SIGMA</strong>. To assure that the member is truly
          legitimate, the founders created only one password.
        </p>
        <p className="mb-6">
          Furthermore, active Founding Father Henry Pesimo added that the two
          Greek words <strong>GAMMA SIGMA</strong> created by the three founders
          serve as a code to recognize a true member of Pi Gamma Phi.
        </p>
        <p className="mb-6">
        ...
        <p>
          Pi Gamma Phi established a good reputation throughout the country from
          its good deeds, following the vision based on the letter by capital of
          the tenets of PI GAMMA PHI 1975 GAMMA SIGMA. The organization has
          seven top priorities and core values that inspire members to do good.
          In addition, PI GAMMA PHI has twelve Golden Rules that serve as its
          fundamental rules.
        </p>

        <div className="my-14 rounded-xl border-y border-[var(--gold)]/50 bg-[var(--green-soft)]/20 py-8 shadow-[0_8px_24px_rgba(15,61,38,0.04)] sm:grid sm:grid-cols-2 sm:gap-8">
          <div>
        ...
        <div className="mt-8 border-l-4 border-[var(--gold)] bg-[var(--green-soft)]/30 p-6 shadow-[0_8px_24px_rgba(15,61,38,0.06)]">
          <h3 className="font-serif text-3xl font-semibold text-[var(--green-dark)]">
            LUX
          </h3>
          <p className="mt-3">
            ...
            vicinity of PI GAMMA PHI 1975 GAMMA SIGMA. As long as there is
            Light, Pi Gamma Phi 1975 Gamma Sigma will never demise.
          </p>
        </div>
        ...
        <div className="mt-8 border-l-4 border-[var(--gold)] bg-[var(--green-soft)]/30 p-6 shadow-[0_8px_24px_rgba(15,61,38,0.06)]">
          ...
          <p className="mt-3">
            Together with one heart and mind, members unite themselves to commit
            and dedicate their lives for the good of their brothers and sisters
            and to other people. God Bless! PI GAMMA PHI 1975 GAMMA SIGMA.
          </p>
        </div>

        <div className="mt-14 rounded-xl bg-[var(--green-dark)] px-6 py-8 text-white shadow-[0_28px_64px_rgba(15,61,38,0.25)] sm:px-10 sm:py-10">
