...
export default function Page() {
  return (
    <PageShell title="Former Master Initiator">
      <div className="mb-10 max-w-2xl">
        <p className="text-base leading-7">
          Honoring the brothers who have served as Master Initiator. Names,
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {formerInitiators.map((initiator) => (
          <article
            key={`${initiator.from}-${initiator.until}`}
          ...
          >
            <div className="relative aspect-[4/5] bg-[var(--green-soft)]">
              <Image
                src={initiator.image}
                alt={`${initiator.name}, former Master Initiator`}
                fill
